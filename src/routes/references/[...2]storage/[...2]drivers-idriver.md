---
title: Drivers - IDriver
---

# {$frontmatter.title}

`IDriver` defines the interface required of all storages to be compatible with Svelte-In-Motion.
...
export interface IDriver {
    ...
    create_hotlink(
        path: string,
        options?: IHotlinkOptions
    ): Promise<IHotlinkHandle>;
